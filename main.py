...
API_ID = int(getenv("API_ID", "17542849"))
API_HASH = getenv("API_HASH", "8f392dfdc2d0d9ca7a6201f373986fb4")
BOT_TOKEN = getenv("BOT_TOKEN", "5347650592:AAHzAlaBUqAQVEbJEyXqgu4WGHt-gShESAc")
OWNER_ID = getenv("OWNER_ID", "5062212424")
